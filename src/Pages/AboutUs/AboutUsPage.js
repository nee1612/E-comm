...
const AboutUs = () => {
  return (
    <>
      <Nav />
      <section className="bg-black text-white h-full py-[3.65rem] px-4 sm:px-8 lg:px-16">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl font-bold mb-8">About Us</h2>
          <p className="text-base sm:text-lg mb-6">
            Welcome to Krist, where fashion meets innovation. Our mission is to
            redefine style with a perfect blend of classic elegance and
